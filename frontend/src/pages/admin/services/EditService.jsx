...
const EditService = () => {
  ...
  // Category options
  const categories = [
    { value: "FOOD", label: "Đồ ăn", icon: Utensils, color: "from-orange-500 to-red-500", bgLight: "bg-orange-50", textLight: "text-orange-600" },
    { value: "DRINK", label: "Thức uống", icon: Coffee, color: "from-blue-500 to-cyan-500", bgLight: "bg-blue-50", textLight: "text-blue-600" },
    { value: "COMBO", label: "Combo", icon: Pizza, color: "from-purple-500 to-pink-500", bgLight: "bg-purple-50", textLight: "text-purple-600" },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 ml-13">Cập nhật thông tin dịch vụ</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                ...
                <p className="text-sm text-gray-500 mt-1 ml-3">Cập nhật thông tin chi tiết của dịch vụ</p>
              </div>
                        ...
                        <button
                          ...
                          className={`px-4 py-3 rounded-xl transition-all duration-200 flex flex-col items-center gap-2 ${
                            isActive
                              ...
                              : `${cat.bgLight} ${cat.textLight} hover:scale-105 border border-gray-200`
                          }`}
                        >
                          <Icon size={24} />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                ...
                <p className="text-sm text-gray-500 ml-7">Cập nhật ảnh cho dịch vụ</p>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 border border-blue-100">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-gray-800 mb-1">Thông tin</p>
                  <ul className="text-xs text-gray-600 space-y-1.5">
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 bg-blue-400 rounded-full"></span>
                      Có thể thay đổi ảnh sau khi cập nhật
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 bg-blue-400 rounded-full"></span>
