...
const LocationMarker = ({ setForm, setMarkerPosition }) => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "address":
        ...
        break;
      case "latitude":
        if (value && (value < -90 || value > 90)) error = "Vĩ độ không hợp lệ (-90 đến 90)";
        break;
      case "longitude":
        if (value && (value < -180 || value > 180)) error = "Kinh độ không hợp lệ (-180 đến 180)";
        break;
    }
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 ml-13">Nhập thông tin chi tiết về rạp chiếu phim</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  ...
                  <p className="text-sm text-gray-500 ml-7">Tải lên ảnh đại diện cho rạp</p>
                </div>
                ...
                <div className="p-6 space-y-4">
                  <div className="rounded-xl overflow-hidden border border-gray-200">
                    ...
                    >
                      ...
                      />
                      <LocationMarker setForm={setForm} setMarkerPosition={setMarkerPosition} />
                    </MapContainer>
                  </div>
